...
Route::middleware('resolve.current.site')->group(function (): void {
    ...
    Route::get('/me/orders', [CustomerProfileController::class, 'indexOrders'])->middleware('auth:customer');
    Route::get('/me/orders/{order}', [CustomerProfileController::class, 'showOrder'])->middleware('auth:customer');
