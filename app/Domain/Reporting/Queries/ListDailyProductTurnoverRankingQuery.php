...
final class ListDailyProductTurnoverRankingQuery
{
    /**
    ...
    private function firstMetricForDirection(
        ...
        $result = DB::table('order_lines')
            ...
            ->orderByRaw(sprintf('SUM(%s) %s', OrderLine::LINE_TOTAL_AMOUNT_CENTS, strtoupper($direction)))
            ...
            ->first([
                ...
                DB::raw(sprintf('SUM(%s) as metric_value', OrderLine::LINE_TOTAL_AMOUNT_CENTS)),
            ]);
